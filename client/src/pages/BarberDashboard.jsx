  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-8">
      <div className="grid md:grid-cols-3 gap-3 mb-5">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded p-4">Waiting: <b>{stats.waiting}</b></div>
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded p-4">Chairs active: <b>{stats.occupied}</b></div>
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded p-4">Avg wait: <b>{stats.avgWait} min</b></div>
      </div>
